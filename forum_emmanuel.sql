...
INSERT INTO `topic` (`id_topic`, `title`, `creationDate`, `closed`, `category_id`, `user_id`) VALUES
	(1, 'Living the Farm Life', '2024-12-18 16:32:14', 0, 1, 1),
	(2, 'Tips for a Beautiful Garden', '2024-12-18 16:32:14', 0, 2, 2),
	(3, 'Raising Healthy Chickens', '2024-12-18 16:32:14', 0, 3, 3),
	(4, 'Methods of Food Preservation', '2024-12-18 16:32:14', 0, 4, 4),
	(5, 'Building Your Own Shed', '2024-12-18 16:32:14', 0, 5, 5);
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `role` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT 'user',
